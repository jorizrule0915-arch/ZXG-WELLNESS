      ...
      <div className="mx-auto max-w-3xl px-6 lg:px-10 py-20 md:py-28">
        ...
        <div className="border-t border-gold/15">
          <Section title="Returns" index={0}>
            <p>
              Due to the nature of health, wellness, and personal care products, returns are
              generally not accepted once an item has been opened or used.
            </p>
          ...
          <Section title="Damaged, Missing, or Incorrect Items" index={1}>
            ...
            <p>
              Once reviewed, we will either send a replacement item or issue a refund to your
