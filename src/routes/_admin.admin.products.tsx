        ...
        <div className="mt-6 border border-gold/15 bg-charcoal overflow-hidden">
          {loading ? (
            ...
            <div className="p-12 text-center">
              <div className="font-display text-2xl">Products could not load</div>
              <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground">{loadError}</p>
              <button
                onClick={load}
                className="mt-5 px-5 py-2 border border-gold/40 text-gold text-[10px] uppercase tracking-luxury hover:bg-gold hover:text-obsidian transition-colors"
              >
                Retry
              </button>
            </div>
