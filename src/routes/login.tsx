    ...
    if (data.session) {
      const redirectTo =
        typeof window !== "undefined"
          ? getSafeRedirectPath(new URLSearchParams(window.location.search))
          : null;
      ...
      throw redirect({ to: isAdmin ? "/admin" : "/account" });
    }
  },
  head: () => ({
    meta: [
      { title: "Sign In — ZXG Wellness" },
      { name: "description", content: "Sign in to your ZXG Wellness atelier account." },
    ],
  }),
  component: LoginPage,
});
