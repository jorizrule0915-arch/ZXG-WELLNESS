...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact the Atelier — ZXG Wellness" },
      {
        name: "description",
        content: "Contact the ZXG Wellness concierge — questions, partnerships, press.",
      },
    ],
  }),
    ...
    <div className="mx-auto max-w-5xl px-6 lg:px-10 py-20 md:py-28 grid lg:grid-cols-2 gap-16">
      <div>
        ...
        <p className="mt-6 text-foreground/75 leading-relaxed max-w-md">
          For private consultations, partnerships, press inquiries, or simply to say hello — we read
