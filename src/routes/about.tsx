...
function AboutPage() {
  return (
    <>
      <Seo
        title="Our Story"
        description="Learn the GXZ Health and Wellness story, our approach to premium wellness products, and our commitment to considered daily care."
        path="/about"
      />
      <JsonLd
        data={[
      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-10 py-20 md:py-32">
        ...
        <div className="mt-20 space-y-12 text-lg leading-relaxed text-foreground/85">
          {[
            "GXZ Health and Wellness was built on a simple belief: that caring for yourself should feel as meaningful as anything else you do with intention. We were founded by people who were tired of wellness that felt clinical, impersonal, or rushed — and who believed that something better was possible.",
